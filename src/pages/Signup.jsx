    ...
    <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', marginBottom: '3rem', maxWidth: '600px' }}>
        ...
        <p style={{ fontSize: '0.92rem', color: 'rgba(255,255,255,0.35)', lineHeight: 1.7, fontWeight: 300, letterSpacing: '0.01em', maxWidth: '480px', margin: '0 auto 2rem' }}>
          Join thousands of users managing their work smarter with AI. Free forever.
        </p>
      ...
      <div style={{
        ...
        <p style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.35)', marginBottom: '1.5rem' }}>
          Start managing tasks smarter with AI — free forever
        </p>
        ...
        <div style={{ marginBottom: '0.875rem' }}>
          <label style={{ display: 'block', fontSize: '0.7rem', fontWeight: 500, color: 'rgba(255,255,255,0.4)', marginBottom: '0.375rem', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Full name</label>
          <input
        ...
        <p style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.3)', textAlign: 'center' }}>
          ...
          <Link to="/login" style={{ color: '#a5b4fc', fontWeight: 500, textDecoration: 'none' }}>
            Sign in
          </Link>
        </p>
      </div>
